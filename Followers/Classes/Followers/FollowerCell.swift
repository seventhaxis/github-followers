...
final class FollowerCell: UICollectionViewCell, ReusableIdentifier {
    ...
    private func setupView() {
        directionalLayoutMargins = ViewMetrics.directionalMargins
        ...
        NSLayoutConstraint.activate([
            ...
            usernameLabel.topAnchor.constraint(equalToSystemSpacingBelow: avatarImageView.bottomAnchor, multiplier: 1.0),
